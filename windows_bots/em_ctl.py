"""
em_ctl.py — direct control tool for EM (Exness <REDACTED_MT5_LOGIN_EM>) — no MCP needed
==========================================================================
Usage:
  python em_ctl.py list
  python em_ctl.py close <ticket>
  python em_ctl.py close_symbol <SYMBOL>
  python em_ctl.py sltp <ticket> <sl> <tp>      (0 keeps current value)
  python em_ctl.py breakeven <ticket>
  python em_ctl.py open <SYMBOL> <buy|sell> <lot> <sl_dist> <tp_dist>   (distances in price units)
"""
import os
import sys
